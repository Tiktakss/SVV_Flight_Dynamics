...
class Half_Time:
    def __init__(self):
        self.parameters=['vane_AOA','elevator_dte','column_fe','lh_engine_FMF','rh_engine_FMF',\
                         ...
                         'Dadc1_mach','Dadc1_cas','Dadc1_tas','Dadc1_altRate',\
                         'measurement_running','measurement_n_rdy','display_graph_state',\
...
#    plt.plot(fugoidtime,trendline)
    ...
    #Dutch roll - roll#
    dutchRdata = matlab.getdata_at_time('Ahrs1_bRollRate',matlab.dutchRstart,\
                                        matlab.dutchRstart+matlab.dutchRtime)/180*np.pi
    dutchRdata2 = matlab.getdata_at_time('Ahrs1_bYawRate',matlab.dutchRstart,\
                                         matlab.dutchRstart+matlab.dutchRtime)/180*np.pi
...
#    plt.plot(dutchRtime,trendline)
    ...
    #short period#
    sh_perioddata = matlab.getdata_at_time('Ahrs1_bPitchRate',matlab.sh_periodstart,\
                                           matlab.sh_periodstart+matlab.sh_periodtime)
    sh_periodtime = matlab.getdata_at_time('time',matlab.sh_periodstart,matlab.sh_periodstart+\
