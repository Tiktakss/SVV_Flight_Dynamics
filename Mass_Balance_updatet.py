...
#plt.figure()
#plt.subplot(221)
#plt.plot(Time,Center_gravity, "bo" , label = "Flight Data")
#plt.title("Center of Gravity")
#plt.ylabel("Distance from nose[cm]")
#plt.xlabel("Time[min]")
#plt.grid(True)
#z5 = np.polyfit(Time[:12], Center_gravity[:12], 1)
#p5 = np.poly1d(z5)
#xp5 = np.linspace(15, 45, 200)
#plt.plot(xp5,p5(xp5),"b--", label="Trendline")
#plt.legend()

#plt.subplot(222)
#plt.plot(AOA[:6],de[:6], "bo", label ="Flight Data")
#plt.title("Elevator trim curve")
#plt.ylabel("$\delta_e[deg]$")
#plt.gca().invert_yaxis()
#plt.xlabel("$\\alpha[deg]$")
#plt.grid(True)
#z6 = np.polyfit(AOA[:6], de[:6], 1)
#p6 = np.poly1d(z6)
#xp6 = np.linspace(3.3, 8, 200)
#plt.plot(xp6,p6(xp6),"b--", label="Trendline")
#plt.legend()
#
#plt.subplot(223)
